...
# Updated for MidiFighter3d by Ismael Serratos - @iaserrat
...
MF3DSIDEBUTTONS_CHANNEL = 3

MF3DSIDEBUTTONS = [22, 21, 20, 25, 24, 23]
...
ENABLE_MF3D_SIDE_BUTTONS = True # Disable if you wish to use other buttons on the MF3D instead

SESSIONLEFT = MF3DSIDEBUTTONS[1] #Session left
SESSIONRIGHT = MF3DSIDEBUTTONS[4] #Session right
SESSIONUP = MF3DSIDEBUTTONS[0] #Session up
SESSIONDOWN = MF3DSIDEBUTTONS[5] #Session down
