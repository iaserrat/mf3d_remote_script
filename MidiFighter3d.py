...
class MidiFighter3d(ControlSurface):
    __doc__ = "Script for MidiFighter3d"

    _active_instances = []
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in MidiFighter3d._active_instances:
    ...
    def _do_combine(self):
        if self not in MidiFighter3d._active_instances:
            MidiFighter3d._active_instances.append(self)
            MidiFighter3d._combine_active_instances()

    def _do_uncombine(self):
        if ((self in MidiFighter3d._active_instances) and MidiFighter3d._active_instances.remove(self)):
    ...
    def _load_MIDI_map(self):
        ...
        for note in range(128):
            ...
            if ENABLE_MF3D_SIDE_BUTTONS and note in MF3DSIDEBUTTONS:
                channel = MF3DSIDEBUTTONS_CHANNEL
            button = ButtonElement(is_momentary, MESSAGETYPE, channel, note)
